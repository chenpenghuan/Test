...
SECRET_KEY = 'zpqs4u-ka@rkup624m=oe(l=vto+h27hlro*(xxas)@ef^qgq^'
...
STATIC_URL = '/static/'
# STATIC_ROOT = '/home/cph/djangoweb/monitor/templates/admin/'
STATIC_ROOT = '/home/cph/mysite/python/djangoweb/monitor/templates/'
STATICFILES_FINDERS = (
